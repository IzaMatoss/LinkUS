  ...
  async function acharPostagensPorUsuario(nome) {
    ...
    try {
      const result = await fetch(
        `https://app-4aeaa295-402a-4d09-80df-d55bc4a98856.cleverapps.io/postagem/acharPostagensUsuario/${nome}`,
        {
          headers: {
          ...
          posts.map(async (post) => {
            try {
              const resInteracao = await fetch(
                `https://app-4aeaa295-402a-4d09-80df-d55bc4a98856.cleverapps.io/interacao/temInteracaoPost`,
                {
                  method: "POST",
                  body: JSON.stringify({
    ...
    async function acharPostagens() {
      try {
        const res = await fetch(
          "https://app-4aeaa295-402a-4d09-80df-d55bc4a98856.cleverapps.io/postagem/acharPostagens",
          {
            method: "GET",
          }
        );
                    ...
                    post.comentarios.map(async (comentario) => {
                      try {
                        const resInteracaoComent = await fetch(
                          `https://app-4aeaa295-402a-4d09-80df-d55bc4a98856.cleverapps.io/interacao/temInteracaoComentario`,
                          {
                            method: "POST",
                            body: JSON.stringify({

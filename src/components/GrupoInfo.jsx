    ...
    if (grupo) {
      async function acharParticipantes() {
        const res = await fetch(
          `https://app-4aeaa295-402a-4d09-80df-d55bc4a98856.cleverapps.io/grupo/acharUsuarios/${grupo.id_grupo}`,
          {
            headers: {
                ...
                <a
                  ...
                  onClick={async () => {
                    if (participante.funcao !== "admin") {
                      ...
                      const res = await fetch(
                        "https://app-4aeaa295-402a-4d09-80df-d55bc4a98856.cleverapps.io/grupo/administrarParticipante",
                        {
                          method: "PUT",
                          body: JSON.stringify(data),
                          headers: {
